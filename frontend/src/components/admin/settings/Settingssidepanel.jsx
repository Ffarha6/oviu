    ...
    <div className="w-full lg:w-80 shrink-0 space-y-4">
            ...
            <li key={i.name}>
              <button className="w-full flex items-center justify-between gap-2 py-2.5 border-b border-primary/5 last:border-0">
                ...
                <span className="flex items-center gap-2">
                  <span className={`text-[11px] font-semibold px-2 py-0.5 rounded-full ${i.statusColor}`}>
                    {i.status}
                  </span>
      ...
      <div className="bg-red-50 border border-red-100 rounded-2xl p-4">
        ...
        <div className="flex items-center justify-between gap-3 bg-white rounded-xl p-3">
          ...
          <button className="text-xs font-semibold text-red-600 border border-red-200 px-3 py-2 rounded-lg shrink-0">
            إعادة تعيين
          </button>
        </div>
      </div>
