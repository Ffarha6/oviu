      ...
      <SectionCard title="إضافة لون جديد">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-primary text-background text-sm font-semibold px-4 py-2.5 rounded-xl hover:opacity-90 transition disabled:opacity-50 self-end"
          >
