...
export default function CheckoutPage() {
  ...
  const t = {
    ar: {
      ...
      stdShipTitle: "تكلفة الشحن",
      stdShipSubPrefix: "يصلك خلال",
      daysUnit: "أيام",
      chooseAddressForShipping: "اختاري عنوان الشحن الأول عشان نظهرلك سعر ومدة التوصيل",
      freeShippingHint: "توصيل مجاني لأول طلب في القاهرة، الجيزة، الإسكندرية، القليوبية والشرقية",
