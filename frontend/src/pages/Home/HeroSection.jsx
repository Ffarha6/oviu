...
useEffect(() => {
  ...
  const heroDesktopImageStyle = {
    objectPosition: "50% 5%",
    transform: "scale(1)",   // ← إزالة التكبير الزائد (كان 1.35)
  }

  // ✅ صورة السلايد التاني (بانر التوصيل المجاني) - خليها scale(1) عشان تظهر
  // كاملة وتملأ المساحة من غير ما تتقص أو تتقلص
  const heroDesktopBannerStyle = {
    transform: "scale(1)",   // ← كانت 0.92 وبقت 1 عشان تظهر كاملة
  }
    ...
    >
      ...
      >
        ...
        {/* =====================================================
            ...
            مع scale(1) عشان يظهر كامل من غير تقليص
        ===================================================== */}
        <motion.img
          key={activeSlide}
          src={heroSlides[activeSlide]}
