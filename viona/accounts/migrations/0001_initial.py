    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prescription_details', models.JSONField(blank=True, default=dict, help_text='{"right_eye": {"sphere": -2.0, "cylinder": -0.5, "axis": 180}, "left_eye": {...}}', verbose_name='prescription details')),
                ('shipping_addresses', models.JSONField(blank=True, default=list, help_text='List of saved addresses', verbose_name='shipping addresses')),
